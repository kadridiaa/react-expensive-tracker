...
function AddTransaction() {
  return (
    ...
    <div className='w-full flex flex-col'>
        <input className='focus:outline-none  border p-2 mt-2' type="text" placeholder='Enter a name for this transaction...' />
        <p className='pt-1 font-[600]'>Amount <br />(native - expense,positive - income)</p>
        <input className='focus:outline-none border p-2 mt-2' type="text" placeholder='Enter amount...' />
    </div>
